...
#[ORM\Entity(repositoryClass: ProductModifierRepository::class)]
#[ORM\Table(name: 'product_modifier')]
class ProductModifier
{
    ...
    #[ORM\ManyToOne(targetEntity: Product::class, inversedBy: 'modifiers')]
