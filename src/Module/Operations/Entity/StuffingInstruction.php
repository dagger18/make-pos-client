...
#[ORM\Entity(repositoryClass: StuffingInstructionRepository::class)]
#[ORM\HasLifecycleCallbacks]
class StuffingInstruction
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?string $forkliftOperator = null;
    ...
    #[ORM\OneToMany(mappedBy: 'stuffingInstruction', targetEntity: StuffingInstructionLine::class, cascade: ['persist', 'remove'])]
    ...
    public function getForkliftOperator(): ?string { return $this->forkliftOperator; }
    public function setForkliftOperator(?string $v): static { $this->forkliftOperator = $v; return $this; }
    ...
    /** @return Collection<int, StuffingInstructionLine> */
