...
class ChargeChargeItemDenormalizer implements DenormalizerInterface
{
    ...
    public function supportsDenormalization(mixed $data, string $type, ?string $format = null, array $context = []): bool
    {
        return 
            ...
            && str_starts_with($context['deserialization_path'], 'chargeItems[')
            && $context['value_type']->getClassName() === 'App\Entity\ChargeItem'
            && $type === Charge::class
        ;
    }
}