...
('MILESTONE_VESSEL_DEPARTED','Vessel Departed','MILESTONE','{\"milestone_code\":\"VESSEL_DEPARTED\"}','[{\"type\":\"JOB_OPERATOR\"}]','[\"IN_APP\",\"EMAIL\"]','email_milestone_vessel_departed',1,'GLOBAL','NORMAL',datetime('now'),datetime('now')),
('MILESTONE_VESSEL_ARRIVED','Vessel Arrived','MILESTONE','{\"milestone_code\":\"VESSEL_ARRIVED\"}','[{\"type\":\"JOB_OPERATOR\"}]','[\"IN_APP\",\"EMAIL\"]','email_milestone_vessel_arrived',1,'GLOBAL','NORMAL',datetime('now'),datetime('now')),
('MILESTONE_DELIVERED','Cargo Delivered','MILESTONE','{\"milestone_code\":\"DELIVERED\"}','[{\"type\":\"JOB_OPERATOR\"}]','[\"IN_APP\",\"EMAIL\"]','email_milestone_delivered',1,'GLOBAL','HIGH',datetime('now'),datetime('now')),
('STATUS_CHANGE','Job Status Changed','STATUS_CHANGE','{}','[{\"type\":\"JOB_OPERATOR\"}]','[\"IN_APP\"]',NULL,1,'GLOBAL','NORMAL',datetime('now'),datetime('now')),
('CUTOFF_SI_48H','SI Cutoff in 48h','DEADLINE','{\"deadline_field\":\"booking.cutoff_si\",\"hours_before\":48}','[{\"type\":\"JOB_OPERATOR\"}]','[\"IN_APP\",\"EMAIL\"]','email_cutoff_si_48h',1,'GLOBAL','HIGH',datetime('now'),datetime('now')),
('INVOICE_OVERDUE_7D','Invoice Overdue 7 Days','FINANCIAL','{\"event\":\"INVOICE_OVERDUE\",\"days_overdue\":7}','[{\"type\":\"JOB_OPERATOR\"}]','[\"IN_APP\",\"EMAIL\"]','email_invoice_overdue',1,'GLOBAL','HIGH',datetime('now'),datetime('now'))
");
